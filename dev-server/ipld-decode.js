...
function from({ name, prefix, encode: encode4, decode: decode7 }) {
  return new Codec(name, prefix, encode4, decode7);
}
function baseX({ name, prefix, alphabet }) {
  const { encode: encode4, decode: decode7 } = base_x_default(alphabet, name);
  return from({
    prefix,
    name,
    encode: encode4,
...
// dev-server/ipld-decode.src.js
self.decodeIPLD = decode6;
